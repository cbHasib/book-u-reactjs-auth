...
const Footer = () => {
  return (
    <footer>
      <div className="container flex flex-col py-3 px-5 mx-auto lg:flex-row bg-base-300">
        ...
        <div className="flex flex-col justify-center pt-6 lg:pt-0">
          <div className="flex justify-center space-x-4">
            <Link
              to="/"
              className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-base-200 hover:bg-primary hover:text-white transition-colors text-base-content"
            >
              <svg
